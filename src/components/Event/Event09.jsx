...
import Img from "../../images/Event09.PNG";
const Events09 = () => {
  return (
    <div>
      <Navbar />
      <div className="container-fluid">
        <div className="boxShadow">
          ...
          <div className="mt-3">
            <h2>Quiz-A-Preneur </h2>
            <p>31st March and 2nd April</p>
          </div>
          <span></span>
          <article>
            <p>Dear Students,</p>
            ...
            <p>
              A flagship event particularly aimed at school students to develop
            ...
            <h5>WINNER</h5>
            <p>
              <strong>1st - Aryaman Drona</strong>
            </p>
            <p>
              <strong>2nd - Tanisha Chakroborty</strong>
            </p>
            <p>
              <strong>3rd - Abhirup Roy</strong>
            </p>
            <p>
              <strong>Special Mention - Srikar Ayalasomayajula</strong>
            </p>
