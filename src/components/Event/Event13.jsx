      ...
      <div className="container-fluid">
        <div className="boxShadow">
          ...
          <article>
            ...
            <p>
              One of a kind event where talent meets opportunity. It was
              ...
              world. Through the donations made on streams,the event managed to
              raise over Rs.11580 to support the Bihari More Education
              Project(BMEP),which assists underprivileged children
            </p>

            <h5>PARTICIPATIONS</h5>
            <p>
              <strong>Registrations: 140, Team Size : 5</strong>
            </p>
            {/* <h5>AWARD</h5>
            <p>
              <strong>
