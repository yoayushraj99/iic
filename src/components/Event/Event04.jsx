...
import Img from "../../images/Event04.PNG";
    ...
    <div>
      ...
      <div className="container-fluid">
        <div className="boxShadow">
          ...
          <div className="mt-3">
            <h2>Bizcup 3.0</h2>
            <p>16th, 17th and 19th. Jan 2020</p>
          </div>
          <span></span>
          <article>
            <p>Dear Students,</p>
            ...
            <p>
              The third edition of Bizcup was held online due to the ongoing
              ...
              and take interest in Entrepreneurship. With over 250 participants,
              BizCup 2021 was one of the biggest events of the year, helping EDC
              with its goal of fostering the entrepreneurial spirit amongst
              college students.
            </p>
            {/* <h5>AWARD</h5>
            <p>
