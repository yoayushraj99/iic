      ...
      <div className="container-fluid">
        <div className="boxShadow">
          ...
          <article>
            ...
            <p>
              One of the world’s largest student entrepreneurship programs
              ...
              build a better world. The OnCampus Rounds of Hult were conducted
              in NIT Durgapur by EDC and saw an overwhelming participation from
              enthusiastic students pitching their best ideas before a panel of
              highly qualified judges and mentors. The winning teams received
              mentorship and went on to the Hult regionals. With more than 25
              teams comprising 120+ students, the first edition of OnCampus Hult
              Prize was a grand success.
            </p>
            {/* <h5>AWARD</h5>
            <p>
              <strong>
