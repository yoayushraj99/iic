...
import Img from "../../images/Event12.PNG";
      ...
      <div className="container-fluid">
        <div className="boxShadow">
          ...
          <article>
            ...
            <p>
              An event based on a real-life scenario involving a spy in a
              ...
              for more than one team.The event tested the strategy-making and
              decision-making skills of the students. Being fun at the same time
              due to the mysterious nature of the contest.
            </p>

            <h5>PARTICIPATIONS</h5>
            <p>
              <strong>Registrations: 75</strong>
            </p>
            {/* <h5>AWARD</h5>
            <p>
              <strong>
